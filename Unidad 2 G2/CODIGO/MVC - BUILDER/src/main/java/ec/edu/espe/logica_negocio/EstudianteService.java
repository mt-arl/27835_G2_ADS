...
public class EstudianteService {
    ...
    public void guardarEstudiante(String id, String nombres, String edadStr) throws Exception {
        ...
        // 2. Crear estudiante usando Builder (validaciones centralizadas)
        Estudiante estudiante = EstudianteBuilder.crearEstudiante(id, nombres, edadStr);
    ...
    public void editarEstudiante(String id, String nombres, String edadStr) throws Exception {
        ...
        // Crear estudiante actualizado usando Builder (sin validar duplicidad)
        Estudiante estudiante = EstudianteBuilder.crearParaActualizacion(id, nombres, edadStr);
