...
export default function OrdersPage() {
    ...
    return (
        <div className="p-6 lg:p-8">
            {/* Header */}
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-slate-800 mb-2">Gestión de Pedidos</h1>
                <p className="text-slate-500">Administra todos los pedidos de los clientes</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <button
                    onClick={loadOrders}
                    className="px-4 py-2 text-sm font-medium bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 transition-colors flex items-center gap-2"
                >
            ...
            <div className="flex flex-wrap gap-4 mb-6">
                ...
                <button
                    ...
                    className={`flex-1 min-w-50 p-4 rounded-xl transition-all text-left flex items-center gap-3 ${filterStatus === 'all'
                        ? 'bg-slate-800 text-white ring-2 ring-offset-2 ring-slate-800'
                        : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                        }`}
                >
                    <i className={`fa-solid fa-list text-xl ${filterStatus === 'all' ? 'text-slate-400' : 'text-slate-500'}`}></i>
                    <div>
                ...
                {['pendiente', 'pagado', 'en proceso', 'despachado', 'completado', 'cancelado'].map(status => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex-1 min-w-50 p-4 rounded-xl transition-all text-left flex items-center gap-3 ${isActive ? activeClasses : inactiveClasses}`}
                        >
                            <i className={`fa-solid ${config.icon} text-xl ${iconColor}`}></i>
                            <div>
