...
function Login({ onLogin }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Login exitoso:', formData.username);
        } catch (error) {
            ...
            <div className="relative z-10 w-full max-w-105 bg-white rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.5)] p-8 md:p-10">
                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="username" className="flex items-center gap-2 text-sm font-semibold text-slate-700">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center gap-2 cursor-pointer text-slate-600 select-none">
                            <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-0" />
                            <span>Recordar sesión</span>
                        </label>
                        <a href="#" className="text-emerald-600 font-semibold hover:text-emerald-700 hover:underline underline-offset-2 transition-colors">
